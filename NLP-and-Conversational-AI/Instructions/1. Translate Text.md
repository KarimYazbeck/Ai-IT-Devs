...
4. Once the terminal starts, run the following commands to download a copy of the repo into your Cloud Shell:
...
5. The files have been downloaded into a folder called **Ai-IT-Devs**. Let's use the Cloud Shell Code editor to open the appropriate folder by running:

    ```bash
        code ai-it-devs/NLP-and-Conversational-AI/Allfiles/01-natural-language-processing
    ```
...
1. In your Cloud Shell editor, expand the *NLP-and-Conversational-AI/Allfiles/01-natural-language-processing** folder, and then the **C-Sharp** or **Python** folder depending on your language preference.
...
4. In the **Main** function, note that code to load the Azure AI Translator key and region from the configuration file has already been provided. The endpoint for the  service is also specified in your code.

5. In your terminal enter the following commands to point the terminal to the appropriate folder and do a test run:

    **C#**

    ```bash
    cd ai-it-devs/NLP-and-Conversational-AI/Allfiles/01-natural-language-processing/C-Sharp/text-translation
    ```
    ...
    **Python**
    ...
    ```bash
    cd ai-it-devs/NLP-and-Conversational-AI/Allfiles/01-natural-language-processing/Python/text-translation
    ```
...
6. Observe the output as the code should run without error, displaying the contents of each review text file in the **reviews** folder. The application currently doesn't make use of Azure AI Translator. We'll fix that in the next procedure.
...
2. In the **GetLanguage** function, under the comment **Use the Azure AI Translator detect function**, add the following code to use the Azure AI Translator's REST API to detect the language of the specified text, being careful not to replace the code at the end of the function that returns the language:
...
3. Save your changes by pressing **CTRL+S** and  and enter the following command in the terminal to run the program:
